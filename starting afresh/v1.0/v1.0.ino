...
void loop() {
  ...
  if (cmnd == 49 || cmnd == 50)
  {
    ...
    if ((dist > 5 && dist < 60) && (distLast1 > 5 && distLast1 < 60)) {
      ...
      //Turn right
      if(((dist>140 && dist<250 && distLast1>140 && distLast1<250 && (abs(distanceCm - distanceCmLast) > 35) && (count == 0 || count  == 1 || count == 4 || count == 5)) || (dist>140 && dist<300 && distLast1>140 && distLast1<300 && (abs(distanceCm - distanceCmLast) > 35) && (count == 2 || count == 3 || count == 6 || count == 7)) &&  cmnd == 49)){
        cmnd = 50;
        esc.write(77);
        wheels.write(50);
        ...
        if (((abs(distanceCm - distanceCmLast) < 50) && (dist<6 || dist>400)) || (distanceCm < 300)) {  
          ...
          wheels.write(110);
          delay(4000); // Havent looked at trash can yet
        }
      } 
